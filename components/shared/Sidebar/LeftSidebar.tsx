...
const LeftSidebar = () => {
  ...
  return (
  <section className='bg-light-900 dark:bg-dark-200 light-border sticky left-0 top-0 flex h-screen flex-col justify-between overflow-y-auto border-r p-6 pt-36 shadow-light-300 dark:shadow-none max-sm:hidden lg:w-[266px] custom-scrollbar'>
            ...
            <SignedOut>
                <div className='flex flex-col gap-3'>
                        ...
                        <Link href='/sign-up'>
                            ...
                            btn-tertiary min-h-[41px] w-full rounded-lg px-4 py-3 shadow-none text-dark-400_light900'>
