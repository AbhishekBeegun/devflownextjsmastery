...
const RightSidebar = () => {
  ...
  return (
    <section className='bg-light-900 dark:bg-dark-200 light-border sticky right-0 top-0 flex h-screen flex-col overflow-y-auto border-l p-6 pt-36 shadow-light-300 dark:shadow-none max-sm:hidden lg:w-[350px] custom-scrollbar'>
